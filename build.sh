...
# Kernel zip module path
	zm=~/Downloads/HolyDragon_OP3_V/Build/modules

# Completed kernel zimage path
	zi=~/Downloads/HolyDragon_OP3_V/Build/boot/Image.gz-dtb
	
# Path to whole kernel zip folders
	zp=~/Downloads/HolyDragon_OP3_V/Build/
	
# Path to whole kernel zip folders
	zu=~/Downloads/HolyDragon_OP3_V/Upload/

# Kernel zip Name
	kn=HDK_OP3_V2.5.6.4.zip
