...
__attribute__((used))DECLARE_TYPE(BANK0_STATE, 3, 0);
__attribute__((used))DECLARE_TYPE(BANK1_STATE, 7, 4);
__attribute__((used))DECLARE_TYPE(BANK2_STATE, 11, 8);
__attribute__((used))DECLARE_TYPE(BANK3_STATE, 15, 12);
/* OCIMEM_PSCGC_TIMERS */
__attribute__((used))DECLARE_TYPE(TIMERS_WAKEUP, 3, 0);
__attribute__((used))DECLARE_TYPE(TIMERS_SLEEP, 11, 8);
/* OCIMEM_HW_VERSION */
__attribute__((used))DECLARE_TYPE(VERSION_STEP, 15, 0);
__attribute__((used))DECLARE_TYPE(VERSION_MINOR, 27, 16);
__attribute__((used))DECLARE_TYPE(VERSION_MAJOR, 31, 28);
/* OCIMEM_HW_PROFILE */
__attribute__((used))DECLARE_TYPE(PROFILE_BANKS, 16, 12);
/* OCIMEM_AXI_ERR_SYNDROME */
__attribute__((used))DECLARE_TYPE(ERR_SYN_ATID, 14, 8);
__attribute__((used))DECLARE_TYPE(ERR_SYN_AMID, 23, 16);
__attribute__((used))DECLARE_TYPE(ERR_SYN_APID, 28, 24);
__attribute__((used))DECLARE_TYPE(ERR_SYN_ABID, 31, 29);
/* OCIMEM_INTC_MASK */
__attribute__((used))DECLARE_TYPE(AXI_ERR_INT, 0, 0);
