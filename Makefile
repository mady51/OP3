...
PATCHLEVEL = 18
SUBLEVEL = 31
EXTRAVERSION = -HolyDragon-v2.5.6.2
...
ARCH		:= arm64
SUBARCH		:= arm64
CROSS_COMPILE	:= /home/holyangel/android/aarch64-cortex_a57-linux-gnu-lin6.4-17.08/bin/aarch64-cortex_a57-linux-gnu-
...
# Graphite
GRAPHITE	:= -fgraphite-identity -floop-nest-optimize -ftree-loop-distribution -ftree-loop-distribute-patterns
